...
use app\assets\GroceryAsset;
use yii\helpers\Html;
use yii\helpers\Url;

/* @var $content string */
GroceryAsset::register($this);
...
<div class="agileits_header">
    ...
    <div class="w3l_search">
        <form action="<?php echo \yii\helpers\Url::to(['/search']);?>" method="get">
   ...
   <?php echo \app\components\widgets\CartButtonWidget::widget();?>
